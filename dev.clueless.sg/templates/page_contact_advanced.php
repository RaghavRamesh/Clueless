...
<head>
    ...
    <!--[if lt IE 9]>
        <link rel="stylesheet" href="static/plugins/sky-forms/version-2.0.1/css/sky-forms-ie8.css">
    <![endif]-->
</head> 
    ...
    <div class="container content">
    	<div class="row margin-bottom-30">
    		<div class="col-md-9 mb-margin-bottom-30">
                ...
                <form action="static/php/demo-contacts-process.php" method="post" id="sky-form3" class="sky-form sky-changes-3">
                    <fieldset>                  
                        <div class="row">
                        ...
                        <section>
                            ...
                            <label class="input input-captcha">
                                <img src="static/plugins/sky-forms/version-2.0.1/captcha/image.php?<?php echo time(); ?>" width="100" height="32" alt="Captcha image" />
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 md-margin-bottom-40">
                        <a href="index.html"><img id="logo-footer" class="footer-logo" src="static/img/logo2-default.png" alt=""></a>
...
<script type="text/javascript" src="static/js/pages/page_contacts.js"></script>
<script type="text/javascript" src="static/js/pages/page_contact_advanced.js"></script>
...
<!--[if lt IE 9]>
    ...
    <script src="static/js/plugins/placeholder-IE-fixes.js"></script>
    <script src="static/plugins/sky-forms/version-2.0.1/js/sky-forms-ie8.js"></script>
<![endif]-->
<!--[if lt IE 10]>
    <script src="static/plugins/sky-forms/version-2.0.1/js/jquery.placeholder.min.js"></script>
<![endif]-->
